...
urlpatterns = [
    ...
    url(r'^reservation/(?P<start_date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/(?P<end_date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/$', views.reservation_room_page,
        name='reservation_room'),
    url(r'^reservation/$', views.reservation_room_page, name='reservation_room'),

    url(r'^reservation/(?P<start_date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/(?P<end_date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/(?P<room>\d+)/$', views.reservation_place_order_page,
